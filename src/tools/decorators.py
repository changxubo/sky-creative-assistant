...
def log_io(func: Callable[..., Any]) -> Callable[..., Any]:
    ...
    def wrapper(*args: Any, **kwargs: Any) -> Any:
        ...
        try:
            ...
            logger.warning(
                f"Tool {function_name} called (parameter logging failed: {e})"
            )
        ...
        try:
            ...
            try:
                ...
                logger.info(
                    f"Tool {function_name} completed successfully (result logging failed: {e})"
                )
...
class LoggedToolMixin:
    ...
    def _log_operation(self, method_name: str, *args: Any, **kwargs: Any) -> None:
        ...
        try:
            ...
            params = ", ".join(filter(None, [args_str, kwargs_str]))
            logger.debug(
                f"Tool {tool_name}.{method_name} called with parameters: {params}"
            )
        except Exception as e:
            logger.debug(
                f"Tool {tool_name}.{method_name} called (parameter logging failed: {e})"
            )
    ...
    def _run(self, *args: Any, **kwargs: Any) -> Any:
        ...
        try:
            ...
            try:
                ...
                logger.debug(
                    f"Tool {tool_name} completed successfully (result logging failed: {e})"
                )
