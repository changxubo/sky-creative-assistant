...
class ReplaysResponse(BaseModel):
    ...
    data: Optional[list[Replay]] = Field(
        default_factory=list, description="List of replays matching the request criteria"  )
    


class ReplaysRequest(BaseModel):
    ...
    offset: Optional[int] = Field(
        None, description="The offset for pagination, used to skip a number of resources"
    )
