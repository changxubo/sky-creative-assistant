...
def get_prose_option(state: ProseState) -> str:
    ...
    if option not in valid_options:
        raise ValueError(f"Invalid prose option '{option}'. Must be one of: {valid_options}")
...
def build_graph():
    ...
    try:
        ...
        for node_name in ["prose_continue", "prose_improve", "prose_shorter", 
                         "prose_longer", "prose_fix", "prose_zap"]:
